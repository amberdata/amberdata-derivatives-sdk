...
class EndpointDeltaSurfaceFloatingTestCase(BaseTestCase):
    ...
    #     self.validate_response_field_timestamp(response, 'timestamp', isMilliseconds=True)
    #
    # def test_timeInterval_minutes(self):
    #     response = self.amberdata_client.get_delta_surfaces_constant(exchange='deribit', currency='BTC', timeFormat='hr', timeInterval='m')
    #     self.validate_response_schema(response, schema=self.schema)
    #     self.validate_response_200(response, num_elements=10)
    #     self.validate_response_field(response, 'exchange', 'deribit')
    #     self.validate_response_field(response, 'currency', 'BTC')
    ...
    #
    # def test_timeInterval_hours(self):
    #     response = self.amberdata_client.get_delta_surfaces_constant(exchange='deribit', currency='BTC', timeFormat='hr', timeInterval='h')
    #     self.validate_response_schema(response, schema=self.schema)
    #     self.validate_response_200(response, num_elements=10)
    #     self.validate_response_field(response, 'exchange', 'deribit')
    #     self.validate_response_field(response, 'currency', 'BTC')
